  ...
  return (
    <div className="min-h-screen bg-black dark:bg-black py-12 pt-36 relative ">
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        {/* Mission Statement */}
        <div className="bg-black dark:bg-black shadow-lg rounded-lg overflow-hidden p-6 mb-8 transition-transform transform hover:scale-105 border border-emerald-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-black dark:bg-black shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 border border-emerald-700">
