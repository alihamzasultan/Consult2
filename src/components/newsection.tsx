...
function NewSection() {
  return (
    <section className="relative z-10 overflow-hidden bg-emerald-700 py-16 px-8 mt-40">
    ...
    <div className="-mx-4 flex flex-wrap items-center">
      <div className="w-full px-4 lg:w-1/2">
        <div className="text-center lg:text-left ">
          <div className="mb-10 lg:mb-0 ">
            ...
            Navigating Innovation Together
            </h1>
      ...
      <div className="w-full px-4 lg:w-1/2">
        <div className="text-center lg:text-right">
          <a
            className="font-semibold rounded-lg mx-auto inline-flex items-center justify-center bg-white text-black py-4 px-9 hover:bg-opacity-90"
            href="contact"
          >
            Send Us a Messeage
          </a>
