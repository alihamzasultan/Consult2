    ...
    <nav className="bg-blue-400 border-gray-200 py-2.5 dark:bg-black sticky top-0 z-50">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div className="flex items-center lg:order-2">
          ...
          <a
            href="/signupPage"
            className="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-blue-800 dark:hover:bg-blue-500 focus:outline-none dark:focus:ring-blue-800"
          >
            Login
          </a>
          <button
