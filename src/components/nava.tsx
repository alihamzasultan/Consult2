    ...
    <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div className="flex items-center lg:order-2">
          ...
          <a
            href="/signupPage"
            className="text-black bg-emerald-500 hover:bg-emerald-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-emerald-500 dark:hover:bg-emerald-800 focus:outline-none dark:focus:ring-emerald-800"
          >
            Sign Up
          </a>
          <button
        ...
        >
          <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            <li>
              <a
                href="/"
                className="block py-2 pl-3 pr-4 text-gray-700 bg-emerald-500 rounded lg:bg-transparent lg:p-0 dark:text-gray-400"
                aria-current="page"
              >
                Home
              </a>
